...
console.log(errors)
   ...
   <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative  bg-white w-[90%] md:w-[80%] lg:w-[60%] max-w-5xl rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden">

        <div className="w-full p-6 sm:p-2 sm:pb-2 sm:pr-10 flex flex-col md:items-end lg:items-end ">
          <h1 className="text-[#3ab19d] font-semibold text-3xl sm:text-4xl lg:text-5xl mb-1">
          ...
          <div className="flex flex-col md:w-[50%] z-1 ">
            <label className="text-gray-900 mb-1">Username</label>
            <input
            ...
            <label className="text-gray-900 mb-1 mt-2">Email</label>
            <input
            ...
            />
              ...
              <p className="text-[red] text-xs">{errors.email.message}</p>
                   ...
                   <label className="text-gray-900 mb-1 mt-2">Number</label>
            <input
            ...
            <label className="text-gray-900 mb-1 mt-2">Password</label>
            <input
        ...
        {!eyepass?<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="grey" class="size-6">
 ...
 <div className="flex flex-col relative">
            <label className="text-gray-900 mb-1 mt-2">Re-enter Password</label>
            <input
