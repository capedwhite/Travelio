import { Check, X, PlusCircle, TrendingUp, Users, DollarSign, Target, Clock, User, Package, Star, IndianRupee, Calendar, MessageSquare, Eye, EyeOff, Receipt, Percent, Handshake } from "lucide-react";
  ...
  if (!bargainsData || bargainsData.length === 0) {
    ...
    md:ml-64">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-slate-600 mb-2">No Bargain Requests</h3>
            <p className="text-slate-500">Bargain requests from customers will appear here</p>
          </div>
        </div>
      </>
    );
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-4 bg-white px-8 py-4 rounded-2xl shadow-lg border border-slate-200 mb-6">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-800">Bargain Management Center</h1>
                <p className="text-slate-600">Manage customer bargain requests and create personalized offers</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-slate-600 mb-2">Total Bargains</p>
                  <p className="text-3xl font-bold text-slate-800">{totalBargains}</p>
                  <p className="text-xs text-slate-500 mt-1">Active negotiations</p>
                </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-amber-700">{pendingBargains}</p>
                  <p className="text-xs text-slate-500 mt-1">Awaiting decisions</p>
                </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-emerald-700">{acceptedBargains}</p>
                  <p className="text-xs text-slate-500 mt-1">Ready for packaging</p>
                </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-slate-600 mb-2">Potential Savings</p>
                  <p className="text-3xl font-bold text-blue-700 flex items-center">
                    <DollarSign className="w-6 h-6" />
                    {totalSavings.toLocaleString()}
                  </p>
                  <p className="text-xs text-slate-500 mt-1">Customer benefits</p>
                </div>
                ...
                <div className="bg-slate-50 p-6 border-b border-slate-200">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h2 className="text-xl font-bold text-slate-800">{pkg.title}</h2>
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-slate-800">{pkg.bargains?.length || 0}</div>
                  ...
                  <div className="px-6 pb-6">
                    {pkg.bargains && pkg.bargains.length > 0 ? (
                              ...
                              <div className="grid md:grid-cols-2 gap-0">
                                ...
                                <div className="p-6 border-r border-slate-200">
                                  ...
                                  <div className="space-y-3">
                                    <div className="flex items-center gap-3">
                                      ...
                                      <span className="font-semibold text-slate-800">{bargainItem.user?.username || "Unknown User"}</span>
                                    </div>
                                    <div className="flex items-center gap-3">
                                      <span className="text-slate-600">{bargainItem.user?.email || "No email provided"}</span>
                                    </div>
                                    <div className="flex items-center gap-3">
                                      <Calendar className="w-4 h-4 text-slate-500" />
                                      <span className="text-slate-600">
                                        Offered: {new Date(bargainItem.offerdate).toLocaleDateString('en-US', {
                                          year: 'numeric',
                                          month: 'long',
                                          day: 'numeric'
                                        })}
                                ...
                                <div className="p-6">
                                  ...
                                  <div className="bg-white rounded-xl p-4 mb-4 border border-slate-200">
                                    <div className="space-y-2">
                                      <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-sm text-slate-800">${originalPrice.toLocaleString()}</span>
                                      </div>
                                      <div className="flex justify-between items-center">
                                        <span className="text-sm text-emerald-600">Offered Price:</span>
                                        <span className="text-sm font-semibold text-emerald-600">${offeredPrice.toLocaleString()}</span>
                                      </div>
                                      <div className="border-t border-slate-200 pt-2">
                                        <div className="flex justify-between items-center">
                                          <span className="font-semibold text-slate-800">Customer Savings:</span>
                                          <span className="font-bold text-blue-600">${savings.toLocaleString()} ({discountPercent}%)</span>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="flex flex-wrap gap-2">
                                    {processingBargain === bargainItem.bargainId ? (
                                      ...
                                      <div className="flex items-center gap-2 text-sm text-emerald-600 bg-emerald-50 px-3 py-2 rounded-lg">
                                        ...
                                        <span>Bargain Accepted - Package Created</span>
                                      </div>
                                    ) : (
                              ...
                              {bargainItem.notes && (
                                <div className="bg-slate-50 p-6 border-t border-slate-200">
                                  <div className="flex items-center gap-3 mb-3">
                                    ...
                                    <h3 className="text-lg font-bold text-slate-800">Customer Notes</h3>
                                  </div>
                                  <div className="bg-white rounded-xl p-4 border border-slate-200">
                                    <p className="text-slate-700 italic">"{bargainItem.notes}"</p>
                                  </div>
                                </div>
                              )}
                            </div>
                      ...
                      <div className="text-center py-8 bg-slate-50 rounded-2xl">
                        ...
                        <p className="text-slate-600">No bargain requests for this package yet</p>
                      </div>
                    )}
                  </div>
                )}
              ...
              <div className="sticky top-0 bg-white rounded-2xl p-6 mb-6 shadow-lg border border-slate-200">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-slate-800">{selectedBargain.bargain.user?.name || selectedBargain.bargain.user?.username}</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-200">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-semibold text-slate-800">Price Comparison</span>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <span className="text-slate-600">Original Price:</span>
                      <span className="font-semibold text-slate-800">${selectedBargain.package.price?.discountedPrice}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-200">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-semibold text-slate-800">Offer Details</span>
                  </div>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-slate-600">Offered Date:</span>
                      <span className="text-slate-800">{new Date(selectedBargain.bargain.offerdate).toLocaleDateString()}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                {selectedBargain.bargain.notes && (
                  <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-200">
                    ...
                    <p className="text-slate-700 leading-relaxed italic">"{selectedBargain.bargain.notes}"</p>
                  </div>
                )}
                ...
                <div className="bg-slate-100 rounded-2xl p-4 mt-6 border border-slate-200">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div className="bg-white rounded-lg p-3 text-center border border-slate-200">
                      <div className="font-bold text-slate-800">{selectedBargain.package.duration}</div>
                      <div className="text-slate-600 text-xs">Duration</div>
                    </div>
                    <div className="bg-white rounded-lg p-3 text-center border border-slate-200">
                      <div className="font-bold text-emerald-700">${selectedBargain.bargain.offerprice}</div>
            ...
            <div className="w-2/3 bg-slate-50 overflow-y-auto">
              <div className="sticky top-0 bg-white border-b border-slate-200 px-6 py-4 z-10">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-bold text-slate-800">Create Custom Package</h2>
                  <span className="text-sm text-slate-600">Special offer for {selectedBargain.bargain.user?.username}</span>
                </div>
              </div>
